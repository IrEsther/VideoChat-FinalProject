...
private String receiverUserId="", receiverUserImg="",receiverUserName="";
private String senderUserId="", senderUserImg="",senderUserName="", checker="";
...
nameContact = findViewById(R.id.name_calling);
        profileImg = findViewById(R.id.profile_img_calling);
...
if (dataSnapshot.child(receiverUserId).exists()){
    ...
    Picasso.get().load(receiverUserImg).placeholder(R.drawable.profi).into(profileImg);
...
userRef.addValueEventListener(new ValueEventListener() {
    @Override
    public void onDataChange(DataSnapshot dataSnapshot) {
       if (dataSnapshot.child(senderUserId).hasChild("Ringind")&&!dataSnapshot.child(senderUserId).hasChild("Calling")){
